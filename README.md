...
项目内部upload内置文件上传webshell,其中mem4_file.jsp为普通的jsp webshell,而mem4.jsp为内存马webshell上传后访问注入完会自动删除(注入路径/mem4).tomcat文件夹内部则内置tomcat内存马(注入路径"/mem4").以上webshell密码都为guangnian.

![image-20260530165137002](C:\Users\黄伟峰\AppData\Roaming\Typora\typora-user-images\image-20260530165137002.png)

![image-20260530165325135](C:\Users\黄伟峰\AppData\Roaming\Typora\typora-user-images\image-20260530165325135.png)

![image-20260530165340096](C:\Users\黄伟峰\AppData\Roaming\Typora\typora-user-images\image-20260530165340096.png)
